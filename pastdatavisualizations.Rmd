...
::: column
```{r}
knitr::include_graphics("assets/gen_art_1.png")
```
**Title:** *Artwork 1*
:::
...
::: column
```{r}
knitr::include_graphics("assets/gen_art_2.png")
```
**Title:** *Artwork 2*
:::
...
::: column
```{r}
knitr::include_graphics("assets/gen_art_3.png")
```
**Title:** *Artwork 3*
...
```{r}
knitr::include_graphics("assets/ggplot_extension.png")
```
...
```{r, out.width="100%"}
knitr::include_graphics("assets/intro_stats.png")
```
...
::: column
```{r}
knitr::include_graphics("assets/dear_data1.jpg")
```
:::

::: column
```{r}
knitr::include_graphics("assets/dear_data2.jpg")
```
:::
:::
**Dataset and variables:**  
...
```{r}
knitr::include_graphics("assets/contour_heatmap.png")
```
